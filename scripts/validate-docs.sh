...
REQUIRED_FILES=(
  ...
  "docs/NETWORK_POINT_READINESS.md"
  ...
  "wiki/Validation-Guide.md"
  "wiki/Security-Boundary.md"
  "wiki/EMB3D-Alignment.md"
  "wiki/Model-Catalog.md"
  "wiki/Evidence-Pack.md"
  ...
  "examples/network-point-readiness-review.md"
  ...
  "evidence/EXAMPLE_EMB3D_ALIGNMENT_REPORT.md"
